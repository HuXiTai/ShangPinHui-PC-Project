        ...
        <div class="InfoWrap">
          <div class="goodsDetail">
            ...
            <div class="priceArea">
              <div class="priceArea1">
                ...
                <div class="remark">
                  <i>累计评价</i>
                  <em>{{ Math.floor(Math.random() * 10000) }}</em>
                </div>
              </div>
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(attr, index) of spuSaleAttrList" :key="index">
                <dt class="title">{{ attr.saleAttrName }}</dt>
                <dd
                  v-for="(item, index) of attr.spuSaleAttrValueList"
                  :class="{ active: item.isChecked === '1' }"
                  @click="changeChecked(attr.spuSaleAttrValueList, index)"
                  :key="index"
                >
...
export default {
  ...
  computed: {
    ...mapState({
      detailData: (state) => {
        return state.detail.detailData;
      },
    }),
    categoryView() {
      return this.detailData.categoryView || {};
    },
    skuInfo() {
      return this.detailData.skuInfo || {};
    },
    spuSaleAttrList() {
